...
const treatments = [
  { name: "GLP-1 Weight Loss", sub: "From $179/mo", href: "/weight-loss", badge: "Most Popular", desc: "Semaglutide & tirzepatide — doctor-guided weight loss with a money-back guarantee." },
