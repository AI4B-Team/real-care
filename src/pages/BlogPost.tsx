...
const POSTS: Record<string, {
  ...
  "compounded-semaglutide": {
    ...
    sections: [
      ...
      { heading: "The Bottom Line", body: "Compounded semaglutide from a licensed pharmacy contains the same active ingredient as Wegovy® at a fraction of the price ($179/mo vs. $1,349/mo for brand-name). Patient outcomes mirror clinical trial data. The main risks — which are manageable — are pharmacy quality and injection technique. Real Care sources medication only from licensed, verified compounding pharmacies and provides dosing instructions with every shipment." },
    ],
