...
const POSTS: Record<string, {
  ...
  "real-care-vs-hims-vs-ro": {
    ...
    sections: [
      ...
      { heading: "The Co-Ed Differentiator", body: "Real Care is the only major telehealth platform built for both men and women on a single platform. Hims serves men (and Hers serves women) on separate brands with separate websites. Ro serves both but doesn't have a couples angle. Real Care's couples plan gives both partners a 15% discount when they enroll together — the only platform offering this. For couples where both partners want to lose weight together, the true price comparison becomes even more favorable." },
      { heading: "The Bottom Line", body: "If you have insurance that covers GLP-1 medications: check Ro's insurance concierge first. If you are paying cash and want the most transparent pricing with no membership fees: Real Care's model is straightforward — one price, everything included. If you want a co-ed platform or are shopping with a partner: Real Care is currently the only option with a couples discount. This comparison reflects publicly available pricing as of April 2026 and may change. Always verify current pricing directly with each provider." },
    ],
  ...
  "compounded-semaglutide": {
    ...
    sections: [
      ...
      { heading: "The Bottom Line", body: "Compounded semaglutide from a licensed pharmacy contains the same active ingredient as Wegovy® at a fraction of the price (from $149/mo vs. $1,349/mo for brand-name). Patient outcomes mirror clinical trial data. The main risks — which are manageable — are pharmacy quality and injection technique. Real Care sources medication only from licensed, verified compounding pharmacies and provides dosing instructions with every shipment." },
    ],
