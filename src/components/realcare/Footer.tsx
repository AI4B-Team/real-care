    ...
    <div className="max-w-[1280px] mx-auto">
      <div className="relative grid lg:grid-cols-[1.2fr_1fr] gap-8 lg:gap-12 items-center bg-white/[0.04] border border-white/10 rounded-2xl p-6 md:p-8 mb-12 overflow-hidden">
        <img
          ...
          height={1024}
          loading="lazy"
          className="hidden lg:block absolute right-[32%] top-1/2 -translate-y-1/2 h-[120%] w-auto pointer-events-none select-none z-10"
        />
        {/* Red video icon to the left of the phone */}
        <div
          aria-hidden="true"
          className="hidden lg:flex absolute right-[44%] top-[18%] z-20 w-11 h-11 rounded-full bg-red items-center justify-center shadow-lg"
        >
