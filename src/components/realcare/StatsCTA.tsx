...
const StatsCTA = () => (
  <div className="bg-red px-5 md:px-12 pt-14 pb-20 text-center">
    ...
    <p className="mt-6 text-[0.85rem] text-primary-foreground/85 max-w-[1100px] mx-auto leading-[1.7] text-center">
      <span className="whitespace-nowrap">One price. No membership fee. No surprises. Unlike <strong className="font-semibold">Hims ($149/mo membership)</strong> and <strong className="font-semibold">Ro ($145/mo membership)</strong>,</span><br />
      Real Care includes everything in one simple price.
    </p>
