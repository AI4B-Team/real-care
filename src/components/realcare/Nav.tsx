    ...
    <nav className="bg-background border-b border-warm-100 flex items-center justify-between px-5 md:px-12 h-16 sticky top-0 z-50 shadow-[0_1px_0_hsl(var(--warm-100))]">
      ...
      <div className="flex items-center gap-2" ref={menuRef}>
        ...
        <div className="relative" ref={langRef}>
          ...
          {langOpen && (
            <div className="absolute top-full right-0 mt-1 w-44 bg-card border border-warm-100 rounded-lg shadow-[0_8px_24px_rgba(0,0,0,0.10)] overflow-hidden z-50 py-1">
              {languages.map((l) => (
                <button
                  key={l.code}
